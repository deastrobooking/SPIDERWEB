...
cd "$OUTPUT_DIR"
zip -r "$PLUGIN_NAME-macOS-ARM.zip" "$VST_BUNDLE_NAME"

echo "Done! macOS ARM VST bundle created at $VST_BUNDLE_DIR"
echo "ZIP archive available at $OUTPUT_DIR/$PLUGIN_NAME-macOS-ARM.zip"